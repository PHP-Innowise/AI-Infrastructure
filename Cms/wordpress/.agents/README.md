...
- **Skills:** `.agents/skills/<name>/SKILL.md` - WordPress workflows for plugins, themes, blocks, REST, content/data, CLI, multisite, WooCommerce, quality, Project Brain, and Memory Bank, plus `SKILL FLOW.md`.
