---
name: release
description: Prepare WordPress project releases with changelog generation, version tags, and optional GitHub publishing. Use when creating a release, generating changelogs, tagging versions, or publishing release notes.
phase: finalization
...
Prepare a WordPress plugin, theme, site component, or package release. Analyze
changes, compatibility and stored-data impact; align WordPress/readme/package
versions; validate the distributable artifact; then create changelog/tag and
optionally publish only after explicit approval.
...
Before publication, run the project's release build and inspect the archive.
Verify plugin/theme headers, `readme.txt` stable tag and tested/requires fields,
text domain, Composer/npm production contents, generated assets, licenses,
upgrade/migration notes, and absence of tests, caches, credentials, source maps
or development dependencies unless the project intentionally distributes them.
For WooCommerce extensions, verify declared HPOS and Blocks compatibility.
