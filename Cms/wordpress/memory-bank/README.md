...
Do not store task plans, speculative ideas, chat transcripts, generic WordPress advice, command output, temporary progress, unresolved guesses, or information already represented adequately by a living spec. Link to the authoritative source instead of copying it.
