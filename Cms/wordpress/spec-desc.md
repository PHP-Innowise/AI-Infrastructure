...
- Project shape: plugin, classic/block theme, site, multisite, or WooCommerce extension
- Runtime: declared WordPress/PHP/Gutenberg/WooCommerce versions
- Auth: cookie/nonce, application password, OAuth/JWT plugin, or integration-specific evidence
- Data: posts/taxonomy/meta/options/custom tables with explicit site/network ownership
- Frontend: theme templates, blocks/editor, admin UI, or an explicitly decoupled client
```
