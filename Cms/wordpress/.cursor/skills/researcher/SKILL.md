---
name: researcher
description: Run structured research to inform a WordPress decision. Use to evaluate libraries/packages, compare approaches, study an unfamiliar codebase area, or gather authoritative references before committing. Triggers on "research", "compare", "evaluate", "which library", "investigate options", "find out how".
phase: understanding
flow-next: council
