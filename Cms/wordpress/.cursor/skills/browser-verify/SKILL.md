---
name: browser-verify
description: Visually verify WordPress web UI changes in a running app. Use for server-rendered pages, forms, and progressive-enhancement workflows that need browser evidence.
phase: execution
flow-next: verify
...
Verify the user-facing behavior of a running WordPress application. Browser verification supplements tests; it does not replace PHPUnit/Pest coverage.
