...
If this is a new project (no existing codebase), ask about tech stack. Keep it simple - these are small projects with straightforward architecture. This base assumes WordPress; a specific framework belongs in the matching sibling accelerator folder (`Laravel/`, `Symfony/`).
