...
description: Generate and maintain WordPress project documentation, READMEs, ADRs, API docs, changelogs, and living specs.
phase: finalization
flow-next: release
...
Document WordPress implementation details in a way that helps future maintainers run, test, extend, and safely operate the system.
