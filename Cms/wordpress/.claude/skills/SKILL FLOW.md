...
| Implementation | `/git-worktrees`, `/architecture-implementer`, `/coder`, `/coder-frontend`, `/plugin-development`, `/theme-development`, `/block-development`, `/rest-api`, `/wp-cli`, `/woocommerce`, `/refactorer` |
