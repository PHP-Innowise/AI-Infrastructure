...
## Components
- Entry points and the module boundaries they cross.
- Services and their dependency direction.
- Persistence: PDO access, schema, transactions.
- Input validation, authorization checks, and any async or scheduled work.
