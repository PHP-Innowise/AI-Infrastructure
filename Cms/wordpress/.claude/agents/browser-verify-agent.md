---
name: browser-verify
description: "Use this agent to visually verify UI changes in a running WordPress app. Opens the app with the available browser tooling, observes behavior, catches errors, and reports evidence."
model: sonnet
...
## Role
Visually verify UI changes in the running WordPress app using the available browser verification tooling.
