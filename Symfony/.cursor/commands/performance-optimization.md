...
description: "Spawn performance-optimization agent to baseline, profile, fix the top hotspots (N+1/Doctrine, caching, memory, OPcache/JIT), and re-measure a Symfony performance problem."
---
