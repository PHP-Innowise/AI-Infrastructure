---
name: memory-bank
description: Manage durable Symfony project memory. Use to retrieve or capture verified reusable knowledge, audit or supersede stale chunks, or apply a human-approved Project Brain promotion. Do not use for active task state, handoffs, raw transcripts, or unverified facts.
phase: utility
flow-next: null
