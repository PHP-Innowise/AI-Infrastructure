---
name: flow-feature
description: "Orchestrate a full feature from the main conversation - requirements, architecture, plan, checkpoint, code, tests, parallel review, verification, finish - by spawning this accelerator's own agents stage by stage with bounded capsule handoffs; expect several agent runs' worth of tokens."
---
