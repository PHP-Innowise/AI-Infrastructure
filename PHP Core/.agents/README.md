...
- **Skills:** `.agents/skills/<name>/SKILL.md` - 31 native-PHP workflows (coder, architect, test-generator, security-reviewer, memory-bank, ...), plus `SKILL FLOW.md` describing the end-to-end flow.
