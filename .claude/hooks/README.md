...
**Purpose:** Outputs project context at session start: git branch, Composer/Laravel markers, configured test/static-analysis tools, optional frontend tooling, and project structure.
...
**Purpose:** Blocks destructive commands: force-push, hard reset, database drops/truncates, dangerous Laravel database resets, secret-writing Composer config, and `--no-verify`.
