...
description: "Spawn database-designer agent to design a relational schema and safe Eloquent access patterns (tables, keys, indexing, constraints, normalization, migrations) for a Laravel project."
---
