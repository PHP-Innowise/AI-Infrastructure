---
name: queues-jobs
description: "Spawn queues-jobs agent to design and implement Laravel queued Jobs: job classes, job middleware, unique jobs, batching, chaining, failed-job handling and retries, and Horizon configuration."
---
