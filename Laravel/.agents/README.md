...
- **Skills:** `.agents/skills/<name>/SKILL.md` - 40 Laravel workflows (coder, architect, filament, eloquent, queues-jobs, test-generator, security-reviewer, memory-bank, ...), plus `SKILL FLOW.md` describing the end-to-end flow.
