...
description: "Spawn events-notifications agent to design and implement Laravel Events, Listeners, model Observers, Notifications (mail/database/broadcast/Slack), and Mailables."
---
