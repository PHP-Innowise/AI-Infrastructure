...
description: "Spawn auth-scaffolding agent to set up Laravel web/session authentication - starter kits, multi-guard configuration, and Policy/Gate authorization patterns."
---
