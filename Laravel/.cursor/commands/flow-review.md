---
name: flow-review
description: "Run a parallel multi-lens review of the current change - code quality, security, performance - by spawning this accelerator's read-only review agents concurrently, then synthesizing one deduplicated report in the main conversation."
---
