---
name: infra-update
description: Upgrade a previously generated accelerator to the current generator version via its .infra-manifest.json, never overwriting user-modified files without an explicit decision.
---
