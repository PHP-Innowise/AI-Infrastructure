...
10. **Log** every hook, its wiring per edition, the section 4/5/6 evidence that authorized each danger rule, the Cursor read-path exception, the three gate variants, and where the dispatch observer is wired versus shipped unregistered.
