...
This flow keeps Symfony work structured while preserving user control. Skills suggest the next skill by its discovered name but do not automatically chain.
...
| Phase | Skills |
| --- | --- |
| Understanding | `requirements-analyst`, `researcher`, `brainstorming` |
